...
export default function Tq2Page() {
  useEffect(() => {
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
  ...
  return (
    <div className="tq2-page-root">
      {/* Background glow effects */}
      <div className="tq2-bg-glow tq2-bg-purple"></div>
      <div className="tq2-bg-glow tq2-bg-green"></div>

      {/* Header / Nav */}
      <header className="tq2-header">
        <div className="tq2-header-inner">
          <a href="/" className="tq2-logo-link">
            <img src="/images/logo/LOGO Dark theme .webp" alt="Mingrow" className="tq2-logo" />
          </a>
        </div>
      </header>

      {/* Main Content */}
      <main className="tq2-main">
        {/* Top Hero Banner Image */}
        <div className="tq2-hero-banner-wrap">
          <picture className="tq2-hero-banner-picture">
            ...
            <img
              ...
              className="tq2-hero-banner-img"
            />
          </picture>
        </div>

        {/* Thank You Title & Subtitle */}
        <div className="tq2-header-section">
          <h1 className="tq2-title">THANK YOU</h1>
          <div className="tq2-title-divider">
            <span className="tq2-star-icon">✦</span>
          </div>
          <p className="tq2-subtitle-heading">We're excited to have you on board.</p>
          <p className="tq2-subtitle-text">
            Our AI Employees are ready to work together and take your business to new heights.
          </p>
        </div>

        {/* Action Cards Container */}
        <div className="tq2-cards-grid">
          {/* Card 1: Watch Demo Video */}
          <div className="tq2-card tq2-card-purple">
            <div className="tq2-card-content">
              <div className="tq2-play-button-wrap">
                <button
                  className="tq2-play-btn"
                ...
                >
                  <svg className="tq2-play-icon" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M8 5v14l11-7z" />
                  </svg>
                </button>
              </div>

              <div className="tq2-card-text-wrap">
                <h3 className="tq2-card-title">Watch Demo Video</h3>
                <p className="tq2-card-desc">
                  See how our AI Employees work together to grow your business.
                </p>
              </div>
            </div>
            <div className="tq2-card-accent-bar tq2-accent-purple"></div>
          </div>

          {/* Card 2: Join WhatsApp Group */}
          <div className="tq2-card tq2-card-green">
            <div className="tq2-card-content">
              <div className="tq2-whatsapp-logo-wrap">
                <a
                  href="https://whatsapp.com/channel/0029Va6DqhaH5JLwvPx90k39"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="tq2-wa-circle"
                  style={{ textDecoration: 'none' }}
                >
                  <svg className="tq2-wa-icon" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="tq2-card-text-wrap">
                <h3 className="tq2-card-title">Join Our WhatsApp Group</h3>
                <p className="tq2-card-desc">
                  Join our exclusive community to get updates, tips, and connect with like-minded business owners.
                </p>
                <div className="tq2-wa-btn-wrap">
                  <a
                    href="https://whatsapp.com/channel/0029Va6DqhaH5JLwvPx90k39"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="tq2-wa-btn"
                  >
      ...
      {/* Footer */}
      <footer className="tq2-footer">
        <div className="tq2-footer-inner">
          <img src="/images/logo/LOGO Dark theme .webp" alt="Mingrow" className="tq2-footer-logo" />
