        ...
        <div className="hero-container">
          ...
          <div className="hero-grid">
            ...
            <div className="hero-left">
              <img
                src="/images/landing1/heroooo.webp"
            ...
            <div className="hero-right">
              ...
              >
                Get your free 7 day trial <span className="cta-arrow">→</span>
              </button>
            </div>
          ...
          {/* BOTTOM STATS BANNER */}
          <div className="lp1-stats-banner" style={{ marginTop: '40px' }}>
            <div className="lp1-stat-item">
              <div className="lp1-stat-icon-wrap">👥</div>
              <div className="lp1-stat-info">
                <span className="lp1-stat-number">20+</span>
                <span className="lp1-stat-label">Hours Saved<br />Every Week</span>
              </div>
            </div>
            ...
            <div className="lp1-stat-item">
              <div className="lp1-stat-icon-wrap">📈</div>
              <div className="lp1-stat-info">
                <span className="lp1-stat-number">3X</span>
                <span className="lp1-stat-label">More Leads<br />Generated</span>
              </div>
            </div>
            ...
            <div className="lp1-stat-item">
              <div className="lp1-stat-icon-wrap">💲</div>
              <div className="lp1-stat-info">
                <span className="lp1-stat-number">70%</span>
                <span className="lp1-stat-label">Lower<br />Operational Costs</span>
              </div>
            </div>
            ...
            <div className="lp1-stat-item">
              <div className="lp1-stat-icon-wrap">🛡</div>
              <div className="lp1-stat-info">
                <span className="lp1-stat-number">99%</span>
